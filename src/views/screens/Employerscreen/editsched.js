...
React.useEffect(()=>{
 navigation.addListener('focus',async () => {
  ...
  const [inputs, setInputs] = React.useState({
   inttype: edit.apply__applicant__schedule__interview_type,
   intWays: edit.apply__applicant__schedule__method,
   intstartdate: edit.apply__applicant__schedule__start_date,
   intenddate: edit.apply__applicant__schedule__end_date,
   intstarttime: edit.apply__applicant__schedule__start_time,
   intendtime: edit.apply__applicant__schedule__end_time,
  });

  
  
var Data ={
        interview_type: inputs.inttype,
        method: inputs.intWays,
        start_date: inputs.intstartdate,
        end_date: inputs.intenddate,
        start_time:inputs.intstarttime,
        end_time:inputs.intendtime
      };
      var headers = {heades : {
...
axiosRequest.patch(`auth/edit/schedule/${edit.apply__applicant__schedule__id}/`, JSON.stringify(Data),{
  headers: {
    'Content-Type': 'application/json'
  }
})  
